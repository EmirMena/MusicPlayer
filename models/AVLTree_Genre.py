...
class AVLTree_Genre:
    ...
    "------------------------------------------------------------------------------------------------------------------------"
    def __ii_rotation(self, node:AVLNode):
        father = node.father
        p = node 
        q = p.left 
        b = q.right 
    ...
    def __dd_rotation(self, node:AVLNode):
        father = node.father
        p = node 
        q = p.right
        b = q.left 
    ...
    def __id_rotation(self, node:AVLNode):
        father = node.father
        p = node 
        q = p.left 
        r = q.right
    ...
    def __recalculate_fe(self, node:AVLNode):
        if node is not None:
            node.f_eq = AVLNode.height(node.right)-AVLNode.height(node.left)
            if abs(node.f_eq) == 2:
                self.__balance(node)
            else:
